  ...
  return (
    <nav className="NavBar">
      <div className="NavBar__left-container">
        <div className="NavBar__left-containe__logo">
          <svg
      ...
      <div className="NavBar__right-container">
        <ul>
          <li>
            <Link to="/host">Conviértete en anfitrión</Link>
          </li>
          <li>
            <a href="">Ayuda</a>
          </li>
          <li>
            <Link to="signup_login">Regístrate</Link>
          </li>
          <li>
            <Link to="signup_login">Iniciar sesión</Link>
          </li>
        </ul>
      </div>
    </nav>
